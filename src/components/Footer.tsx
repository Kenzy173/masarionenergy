...
export function Footer() {
  return (
    <>
      {/* CTA bar: carried from the predecessor site */}
      <div className="border-t border-line bg-paper-warm">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-10 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="type-subhead text-ink">Need a quick help or have questions?</p>
            <p className="mt-1 type-body-sm text-ink-soft">
              Speak directly with our team, Monday to Friday.
            </p>
          </div>
          <a
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
          ...
          <div className="mt-12 flex flex-col gap-4 border-t border-indigo-700 pt-8 text-sm text-indigo-300 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="/terms" className="text-indigo-200 transition-colors hover:text-paper">
                Terms
              </a>
